...
jComboBox1.addActionListener(new java.awt.event.ActionListener() {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        JFrameInitialPatient pacienteFrameInitialPatient = new JFrameInitialPatient(paciente.getId());
        pacienteFrameInitialPatient.setVisible(true);
        this.dispose();
    ...
    private void cmbDoctorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbDoctorActionPerformed
        ...
        for (ExistentDoctorDTO doctor : doctores) {
            cmbDoctor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[]{doctor.getName()}));
        }    
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        doctores = doctorDAO.searchBySpecialization(Specialization.FAMILY); 
